...
unsigned int escala = 1;												// Vale 1 si la distribución es lineal y 2 si es logarítmica
...
unsigned int frecuencia_int;												// Frecuencia anterior guardada
char* frecuencia_a;													// Frecuencia anterior que se muestra en el LCD
char* dft;														// Mensaje de módulo de la DFT para el LCD
char* dft_;														// Módulo de la DFT que muestra el LCD
unsigned int dft_int;													// Módulo de la DFT anterior guardado
char* dft_a;														// Módulo de la DFT anterior que se muestra en el LCD
unsigned int scroll = 0;												// Contador para el scroll del LCD
char cadena[7];														// Array para la función getCadTeclado	
...
float pasoLogs;			
float logs[14] = {1.6335, 1.5229, 1.4449, 1.3870, 1.3424, 1.3069, 1.2781, 1.2542, 1.2341, 1.2167, 1.2020, 1.1891, 1.1777, 1.1676};
