...
typedef unsigned int size_t;			// Tipo de una variable que define el tamaño de una zona de memoria
...
#define RET_5S		5000000		// Constante para un retardo de 5seg. aprox. en retardo()
#define RET_1S		1000000		// Constante para un retardo de 1seg. aprox. en retardo()
#define RET_50MS        50000		// Constante para un retardo de 50ms aprox. en retardo()
